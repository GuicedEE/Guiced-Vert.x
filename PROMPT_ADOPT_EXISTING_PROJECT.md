...
- Repository URL / local path: https://github.com/GuicedEE/Guiced-Vert.x.git
- Org and project name: GuicedEE / Guiced-Vert.x
- Short description: Bridge client between GuicedEE and Vert.x; registers Vert.x via GuicedEE client, supplies utilities/annotations/SPI, and exposes Vertx injection bound as a static singleton in GuicedEE Client PreStartup.
